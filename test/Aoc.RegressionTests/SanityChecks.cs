...
public class SanityChecks
{
    ...
    public void Day16Tests()
    {
      ...
      Assert.True(runner.Puzzle2() == 2191);
    }
    ...
    public void Day19Tests()
    {
      ...
      Assert.True(runner.Puzzle1() == 1294);
      Assert.True(runner.Puzzle2() == 13640);
    }
    ...
    public void Day23Tests()
    {
      ...
      Assert.True(runner.Puzzle1() == 4052);
      Assert.True(runner.Puzzle2() == 978);
    }
    ...
    public void Day24Tests()
    {
      ...
      Assert.True(runner.Puzzle1() == 277);
      Assert.True(runner.Puzzle2() == 877);
    }
